...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Get timely alerts for upcoming maintenance based on your vehicle's needs.",
      icon: Bell,
      color: "text-neon-purple"
    },
    {
      title: "Performance Metrics",
      description: "Track fuel efficiency, costs, and other important performance metrics.",
      icon: BarChart3,
      color: "text-neon-pink"
    },
    {
      title: "AI Repair Assistant",
      description: "Get expert advice and DIY repair guidance from our intelligent AI assistant.",
      icon: MessageSquare,
      color: "text-neon-blue"
    }
  ];
  ...
  const testimonials = [
    {
      name: "Alex Johnson",
      role: "Car Enthusiast",
      content: "AutoMate has completely changed how I maintain my vehicles. The reminders ensure I never miss an oil change, and the AI assistant has saved me thousands in repair costs.",
      avatar: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3"
    },
    {
      name: "Sarah Miller",
      role: "Busy Professional",
      content: "As someone who knows next to nothing about cars, this app is a lifesaver. It tells me exactly what needs to be done and when, in simple terms I can understand.",
      avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=3000&auto=format&fit=crop&ixlib=rb-4.0.3"
    },
    {
      name: "David Chen",
      role: "Small Fleet Owner",
      content: "Managing maintenance for multiple vehicles used to be a nightmare. With AutoMate, I can track everything in one place, saving me both time and money.",
      avatar: "https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?q=80&w=3734&auto=format&fit=crop&ixlib=rb-4.0.3"
    }
  ];
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-opacity duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center stagger-animation">
            ...
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
              Your <span className="text-gradient">Smart Solution</span> for Vehicle Maintenance
            </h1>
            <p className="text-xl text-foreground/80 mb-8 leading-relaxed">
              Keep your vehicles in peak condition with intelligent maintenance tracking, timely reminders, and AI-powered repair assistance.
            </p>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-5">Powerful Features for Your Vehicle</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className={`w-12 h-12 rounded-lg ${feature.color === 'text-neon-blue' ? 'bg-neon-blue/10' : feature.color === 'text-neon-purple' ? 'bg-neon-purple/10' : 'bg-neon-pink/10'} flex items-center justify-center mb-5`}>
          ...
          <div className="mt-16 text-center">
            <Link to="/register">
              <Button variant="outline" size="lg" className="border-white/10 hover:bg-white/5 gap-2">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            <div className="lg:w-1/2 order-2 lg:order-1">
              <div className="glass-card rounded-xl overflow-hidden border border-white/10 shadow-[0_20px_50px_-15px_rgba(0,243,255,0.15)]">
                <img 
                  src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3" 
            ...
            <div className="lg:w-1/2 order-1 lg:order-2">
              <div className="max-w-lg">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Stay on Top of Your Vehicle Maintenance</h2>
                <p className="text-lg text-foreground/70 mb-8">
                  AutoMate provides a comprehensive dashboard that gives you instant visibility into your vehicle's health, upcoming services, and maintenance history.
                </p>
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-5">What Our Users Say</h2>
            <p className="text-lg text-foreground/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <div key={testimonial.name} className="glass-card rounded-xl p-6 transition-all animate-float">
      ...
      <section className="py-20 md:py-28 bg-dark-card relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-5">Simple, Transparent Pricing</h2>
            <p className="text-lg text-foreground/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingTiers.map((tier) => (
              <div 
                key={tier.name} 
                className={`glass-card rounded-xl p-6 border ${tier.popular ? 'border-neon-purple/50 shadow-[0_0_30px_-10px_rgba(188,19,254,0.3)]' : 'border-white/10'} relative`}
              >
                {tier.popular && (
                ...
                <div className="text-center py-4">
                  ...
                  <Link to="/register">
                    <Button 
                      className={`w-full ${tier.buttonVariant === 'outline' ? 'border-white/10 hover:bg-white/5' : tier.popular ? 'bg-neon-purple hover:bg-neon-purple/90 text-white' : 'bg-neon-blue hover:bg-neon-blue/90 text-black'}`}
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Take Control of Your Vehicle Maintenance?</h2>
            <p className="text-lg text-foreground/70 mb-8">
