            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-2 mt-4">
                  ...
                  <label htmlFor="terms" className="text-sm text-foreground/70">
                    I agree to the <Link to="/terms" className="text-neon-blue hover:text-neon-blue/90">Terms of Service</Link> and <Link to="/privacy" className="text-neon-blue hover:text-neon-blue/90">Privacy Policy</Link>
                  </label>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-white/10 text-center">
                <div className="flex items-center justify-center gap-1.5">
                  ...
                  <Link to="/login" className="text-neon-blue hover:text-neon-blue/90 font-medium">
                    Sign in
                  </Link>
                </div>
              </div>
